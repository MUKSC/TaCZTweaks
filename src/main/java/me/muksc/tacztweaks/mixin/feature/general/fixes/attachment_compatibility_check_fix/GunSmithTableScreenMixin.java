...
public abstract class GunSmithTableScreenMixin {
    ...
    private boolean tacztweaks$isSuitableForMainHand$attachmentCompatibilityCheckFix(IGun instance, ItemStack gun, ItemStack attachmentItem, Operation<Boolean> original) {
